...
public class TsinjoController {
    ...
    public String home(Model model) {
        ...
        List<?> allMovements = Stream.concat(donations.stream(), aids.stream())
    ...
    public RedirectView submitDonation(@RequestParam String donorName, @RequestParam String donorEmail,
                                       @RequestParam double amount, @RequestParam String pspType,
